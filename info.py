...
BOT_TOKEN = environ.get('BOT_TOKEN', '7742045300:AAEkiQ_Hi5Xbl3fVGisKLL5acdVjui35aYo')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002131471204').split()]
